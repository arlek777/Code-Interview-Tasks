namespace ChatBot
{
    public static class DataSource
    {
        public static string[][] KnowledgeBase = {
            ...
            new string[] {"BOT DONT UNDERSTAND**",
            ...
            new string[] {"NULL INPUT REPETITION**",
                "WHAT ARE YOU DOING??",
            ...
            new string[] {"ARE YOU A HUMAN BEING",
                "WHY DO YOU WANT TO KNOW?",
                "IS THIS REALLY RELEVENT?"
            },
            new string[] {"YOU ARE VERY INTELLIGENT",
            ...
            new string[] {"NOT REALLY",
                "OK I SEE.",
                "YOU DONT SEEM PRETTY CERTAIN.",
                "SO,THAT WOULD BE A \"NO\"."
            },
            new string[] {"IS THAT TRUE",
